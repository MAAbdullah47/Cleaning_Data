...
vector
names(Activity_Train_Y) = c("Activity Code")
...
Merge_Subject_Activity_Plus_Measurment <- data.frame(Merge_Subject_Activity_Measurment , Train_Data_Measurment) 
#----->End Training Subset
#------>Start Test Subset
...
library(data.table)
dt1 <- data.table(Merge_Subject_Activity_Plus_Measurment, key = "Subject.Code") 
dt2 <- data.table(Merge_Test_Subject_Activity_Plus_Measurment, key = "Subject.Code") 
